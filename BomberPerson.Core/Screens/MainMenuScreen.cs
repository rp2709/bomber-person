...
using BomberPerson.Core;
using BomberPerson.Core.Effects;
using BomberPerson.Core.Inputs;
...
namespace BomberPerson.Screens;
...
class MainMenuScreen : MenuScreen
{
    ...
    private void SetLanguageText()
    {
        ...
        Title = "BomberPerson"; // TODO uncomment this if you want it to use Resources.MainMenu; instead
    }
    ...
    public override void LoadContent()
    {
        ...
        settingsManager ??= ScreenManager.Game.Services.GetService<SettingsManager<BomberPersonSettings>>();
