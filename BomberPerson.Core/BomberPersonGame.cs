...
using BomberPerson.Core.Effects;
using BomberPerson.Core.Localization;
using BomberPerson.Core.Settings;
using BomberPerson.ScreenManagers;
using BomberPerson.Screens;
...
namespace BomberPerson.Core
{
    ...
    public class BomberPersonGame : Game
    {
        ...
        private SettingsManager<BomberPersonSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<BomberPersonLeaderboard> leaderboardManager;
        ...
        public BomberPersonGame()
        {
            ...
            settingsManager = new SettingsManager<BomberPersonSettings>(storage);
            Services.AddService(typeof(SettingsManager<BomberPersonSettings>), settingsManager);

            leaderboardManager = new SettingsManager<BomberPersonLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<BomberPersonLeaderboard>), leaderboardManager);
